...
class StorageStyle:
    ...
    def deserialize(self, mutagen_value: MutagenFile): ...
    def set(self, mutagen_file: MutagenFile, value) -> None: ...
    def store(self, mutagen_file: MutagenFile, value) -> None: ...
...
class ListStorageStyle(StorageStyle):
    ...
    def fetch(self, mutagen_file: MutagenFile): ...
    def set(self, mutagen_file: MutagenFile, value) -> None: ...
    def set_list(self, mutagen_file: MutagenFile, values) -> None: ...
    def store(self, mutagen_file: MutagenFile, values) -> None: ...
...
class MediaField:
    ...
    def __set__(self, mediafile: MediaFile, value) -> None: ...
...
class ListMediaField(MediaField):
    ...
    def __set__(self, mediafile: MediaFile, values) -> None: ...
